...
#     ms = await bot.send_message(call_back.from_user.id, text=mt.welcome_message_on_group_new_dong(group_name=group_name), )
#     await bot.register_next_step_handler(ms, stages.stage_begin, call_back.message.chat.id)
