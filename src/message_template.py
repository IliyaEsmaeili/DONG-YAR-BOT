...
لطفا اسم هر شخص بدون فاصله بنویس یا برای جدا کردن بخش های اسم هر شخص، بین بخش ها "-" (خط تیره) قرار بده
...
وقتی من پیدام شد، کسی که پول رو حساب کرده (مادرخرج) روی دکمه‌ی پیامی که می‌فرستم کلیک می‌کنه. اونجا اطلاعات مورد نیازو ازش می‌پرسم:
شماره کارتت چیه؟ 💳
